...
public class JStatusBar extends JPanel implements ChangeListener {
	...
	public JStatusBar() {
		...
		// Create a pane to hold just the buttons so we can stack them on top of each
		// other
	...
	// This is called when the display screen is very small and certain components
	// need removing
