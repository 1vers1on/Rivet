...
public class OFDM extends FFT {
	...
	// Check an OFDM signal described as a list of CarrierInfo objects has the
	// correct spacing
	...
	// Find the peaks in the spectrum data within a certain range and return them as
	// CarrierInfo objects
	public List<CarrierInfo> findOFDMCarriersWithinRange(double spectrum[], double sampleRate, int binCount,
			double multiFactor, int startBin, int endBin) {
		List<CarrierInfo> cList = new ArrayList<CarrierInfo>();
		int a;
		double dPoint = -1.0;
