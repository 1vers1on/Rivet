...
public class CROWD36 extends MFSK {
	...
	private final int TONES[] = { 1410, 1450, 1490, 1530, 1570, 1610, 1650, 1690, 1730, 1770, 1810, 1850, 1890, 1930,
			1970, 2010, 2050, 2090, 2130, 2170, 2210, 2250, 2290, 2330, 2370, 2410, 2450, 2490, 2530, 2570, 2610, 2650,
			2690, 2730 };
	private int toneCount[] = new int[34];
	private int toneLowCount;
	private int toneHighCount;
	private int syncHighTone = 24;
	private final String DEBUGLETTERS[] = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O",
	...
	private void displayMessage(int freq, boolean isFile) {
		...
		if (theApp.isDebug() == false) {
			...
			// Debug
			if (tone == -1)
				theApp.writeChar("*", Color.BLACK, theApp.boldFont);
			else
				theApp.writeChar(DEBUGLETTERS[tone], Color.BLACK, theApp.boldFont);
			lineCount++;
			if (lineCount == 80) {
				lineCount = 0;
				theApp.newLineWrite();
	...
	private String getChar(int tone) {
		String out = "";
		final String C36A[] = { "Q", "X", "W", "V", "E", "K", " ", "B", "R", "J", "<*10>", "G", "T", "F", "<fs>", "M",
				"Y", "C", "cr", "Z", "U", "L", "<*22>", "D", "I", "H", "<ls>", "S", "O", "N", "<*30>", "A", "P",
				"<*33>" };
		final String F36A[] = { "1", "\u0429", "2", "=", "3", "(", " ", "?", "4", "\u042e", "<*10>", "8", "5", "\u042d",
				"<fs>", ".", "6", ":", "cr", "+", "7", ")", "<*22>", " ", "8", "\u0449", "<ls>", "", "9", ",", "<*30>",
				"-", "0", "<*33>" };

		// final String CRY36[]={"\u042f","\u044a","\u0412","\u04c1","\u0415","\u041a","
		// ","\u0411","\u0420","\u0419","<*10>","\u0490","\u0422","\u0424","<fs>","\u043c","\u042b","\u0426","cr","\u0417","\u0423","\u043b","<*22>","\u0414","\u0418","\u0425","ls","\u0421","\u041e","\041d","<*30>","\u0410","\u041f","<*33>"};
	...
	private String syncToneHunt(CircularDataBuffer circBuf, WaveData waveData) {
		...
		String line = theApp.getTimeStamp() + " CROWD36 Sync Tones Found (Correcting by "
				+ Integer.toString(correctionValue) + " Hz) sync tone difference " + Integer.toString(difference)
				+ " Hz";
		return line;
	}
	...
	public String lowHighFreqs() {
		String line;
		line = "Lowest frequency " + Integer.toString(lowFreq) + " Hz : Highest Frequency " + Integer.toString(highFreq)
				+ " Hz";
		return line;
	}
